      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 3),
            Text(
              'POD ${repAssessment.podContext}',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 10,
                fontWeight: FontWeight.w600,
                color: selected ? AppColors.primary : const Color(0xFF727687),
              ),
            ),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            _StatusOptionTile(
              ...
              enabled: true,
              onTap: () => setState(() => _selectedTriage = 'RED'),
            ),
            const SizedBox(height: 8),
            _StatusOptionTile(
              title: 'Cần theo dõi',
              ...
              enabled: true,
              onTap: () => setState(() => _selectedTriage = 'YELLOW'),
            ),
            const SizedBox(height: 8),
            _StatusOptionTile(
              title: 'Ổn định',
              ...
              enabled: true,
              onTap: () => setState(() => _selectedTriage = 'GREEN'),
            ),
          ],
        ),
      ),
...
// ─────────────────────────────────────────────────────────────────────────────
// Compliance tab — checklist + counters
// ─────────────────────────────────────────────────────────────────────────────
...
class _ComplianceInfoCardShell extends StatelessWidget {
  const _ComplianceInfoCardShell({required this.child});
  final Widget child;
