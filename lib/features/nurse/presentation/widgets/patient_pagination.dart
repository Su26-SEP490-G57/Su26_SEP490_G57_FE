    ...
    return Column(
      children: [
        ...
        const Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.swipe_rounded, size: 14, color: Color(0xFFBBBEC8)),
            SizedBox(width: 4),
            Text(
...
class _PageDots extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (totalPages <= _maxVisible) {
      ...
      start = (currentPage - (_maxVisible ~/ 2)).clamp(
        1,
        totalPages - _maxVisible + 1,
      );
    }
    ...
    return Row(
      ...
      children: List.generate(visible, (i) {
        ...
        final isEdge =
            totalPages > _maxVisible &&
            (i == 0 && start > 1 ||
                i == visible - 1 && start + visible - 1 < totalPages);
