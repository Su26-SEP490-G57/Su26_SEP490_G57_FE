...
class _PatientNotificationsPageState
  ...
  Widget _buildLockedPodAlertCard(BuildContext context, String? holdReason) {
    ...
    if (reasonText.contains('Auto-locked: Reached max POD with concerning health status')) {
      reasonText = 'Tự động tạm dừng: Đã đạt mốc ngày POD tối đa với mức độ sức khỏe cần theo dõi kỹ (Vàng/Đỏ).';
