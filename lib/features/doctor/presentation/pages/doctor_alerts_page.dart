...
class _HandledAlertCard extends StatelessWidget {
  ...
  Color get _severityColor =>
      alert.alertType == 'RED' ? const Color(0xFFBA1A1A) : const Color(0xFFA33200);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  const Icon(Icons.schedule_rounded, size: 16, color: Color(0xFF727687)),
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.error_outline_rounded, color: Color(0xFFBA1A1A), size: 42),
            const SizedBox(height: 12),
            const Text(
