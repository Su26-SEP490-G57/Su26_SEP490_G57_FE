...
class _AlertCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final borderColor = isRed ? const Color(0xFFFCA5A5) : const Color(0xFFFDE68A);
    final accentColor = isRed ? const Color(0xFFDC2626) : const Color(0xFFD97706);
    ...
    final operationType = (patient?.operationTypeName != null && patient!.operationTypeName!.isNotEmpty)
